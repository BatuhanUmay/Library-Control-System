...
if(isset($_POST['guncelle'])){ // güncelle butonu geldiyse
    ...
    header("Location:profilbilgileri.php");
}
            ...
            <div class="row">
                <div class="col">
                    ...
                    <a href="studentHome.php" class="btn btn-outline-primary">Ana Sayfa</a>
                        <a href="profilbilgileri.php" class="btn btn-outline-primary">profilbilgileri</a>
                ...
                <div class="row mt-4 g-3">
                        <form class="row mt-4 g-3">
                            ...
                            <div class="col-6">
                                ...
                                <input type="datetime" class="form-control" name="tarih" value="<?= $satir["createDate"]?>">
